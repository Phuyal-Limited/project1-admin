...
--
-- Host: localhost
-- Generation Time: Oct 26, 2013 at 12:17 PM
...
CREATE TABLE IF NOT EXISTS `books` (
  ...
  `authurs` text NOT NULL COMMENT 'seperated by comma',
...
INSERT INTO `books` (`book_id`, `book_name`, `isbn10`, `isbn13`, `authurs`, `description`, `category_id`, `publisher`, `image_id`, `language`, `weight`, `published_date`) VALUES
(1, 'What Is Contemporary Art?', '0-226-76430-3', '978-0-226-76430-6', 'Terry Smith', 'Terry Smith is the Andrew W. Mellon Professor.', '1', 'The University of Chicago Press', 1, 'English', 0, '2013-10-22');
